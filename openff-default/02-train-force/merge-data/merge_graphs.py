...
# ----
MAX_ENERGY = 0.1
entries = glob.glob("./openff-2.0.0_filtered_lazy/duplicated-isomeric-smiles/*/*")
...
for i, entry in enumerate(entries):
    ...
    if len(os.listdir(entry)) != 1:
        ...
        _output_prefix = os.path.join("./openff-2.0.0_filtered_lazy/duplicated-isomeric-smiles-merge", mydict[smile_name], dataset)
